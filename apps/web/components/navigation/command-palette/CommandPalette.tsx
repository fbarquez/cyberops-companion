...
const navigationItems: NavigationItem[] = [
  ...
  { id: "compliance", label: "Compliance Hub", href: "/compliance", icon: Scale, keywords: ["compliance", "regulatory", "frameworks"] },
  { id: "nis2", label: "NIS2 Directive", href: "/compliance/regulatory/nis2", icon: Globe, keywords: ["compliance", "eu", "directive", "regulatory"] },
  { id: "dora", label: "DORA", href: "/compliance/regulatory/dora", icon: Landmark, keywords: ["compliance", "financial", "resilience", "regulatory"] },
  { id: "iso27001", label: "ISO 27001", href: "/compliance/frameworks/iso27001", icon: ShieldCheck, keywords: ["compliance", "standard", "framework"] },
  { id: "bsi", label: "BSI IT-Grundschutz", href: "/compliance/frameworks/bsi", icon: Building, keywords: ["compliance", "german", "framework"] },
