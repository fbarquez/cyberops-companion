const translations = {
  en: {
    ...
    auth: {
      ...
      ssoWelcomeNew: "Welcome, {{name}}! Your account has been created.",
      ssoWelcomeBack: "Welcome back, {{name}}!",
  ...
  de: {
    ...
    auth: {
      ...
      ssoWelcomeNew: "Willkommen, {{name}}! Ihr Konto wurde erstellt.",
      ssoWelcomeBack: "Willkommen zuruck, {{name}}!",
