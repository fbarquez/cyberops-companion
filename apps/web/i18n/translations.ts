const translations = {
  en: {
    ...
    training: {
      ...
      subtitle: "Learn, practice, and improve your security skills",
      ...
      // Categories
      "categories.security_fundamentals": "Security Fundamentals",
      "categories.phishing_awareness": "Phishing Awareness",
      "categories.data_protection": "Data Protection",
      "categories.password_security": "Password Security",
      "categories.social_engineering": "Social Engineering",
      "categories.compliance": "Compliance",
      "categories.incident_response": "Incident Response",
      "categories.secure_coding": "Secure Coding",
      // Module types
      "moduleTypes.video": "Video",
      "moduleTypes.text": "Text",
      "moduleTypes.interactive": "Interactive",
      "moduleTypes.quiz": "Quiz",
      "moduleTypes.document": "Document",
      "moduleTypes.external_link": "External Link",
      // Enrollment
      enrollNow: "Enroll Now",
      enrollDescription: "Enroll to start learning and track your progress.",
      startLearning: "Start Learning",
      enrolling: "Enrolling...",
      enrolledSuccessfully: "Successfully enrolled in course!",
      enrollmentFailed: "Failed to enroll in course",
      // Progress
      ...
      deadline: "Deadline",
      overdueDeadline: "Deadline passed",
      // Module viewer
      ...
      progress: "Progress",
      readyToComplete: "Ready to complete this module?",
      markAsComplete: "Mark this module as complete to track your progress",
      markComplete: "Mark as Complete",
      completing: "Completing...",
      moduleCompleted: "Module completed!",
      completionFailed: "Failed to mark module as complete",
      noVideoAvailable: "No video available",
      downloadDocument: "Download the document to continue learning",
      download: "Download",
      noContentAvailable: "No content available",
      externalResource: "This module links to an external resource",
      openResource: "Open Resource",
      quizModule: "Quiz Module",
      quizDescription: "Test your knowledge with this quiz",
      startQuiz: "Start Quiz",
      quizNotAvailable: "Quiz not available",
      interactiveNotAvailable: "Interactive content not available",
      ...
      moduleNotFoundMessage: "The module you're looking for doesn't exist.",
    ...
    onboarding: {
      ...
      step1Title: "Organization Profile",
      step1Subtitle: "Tell us about your organization",
      ...
      euOperations: "EU Operations",
      // Industry Categories
      financial: "Financial Services",
      criticalInfrastructure: "Critical Infrastructure",
      automotive: "Automotive",
      general: "General",
      // Step 2: Special Status
      step2Title: "Regulatory Status",
      step2Subtitle: "Help us identify applicable regulations",
      specialStatus: "Special Status",
      isKritisOperator: "KRITIS Operator",
      kritisDescription: "Operator of critical infrastructure in Germany",
      isBaFinRegulated: "BaFin Regulated",
      bafinDescription: "Supervised by German Financial Authority",
      isEssentialService: "Essential Service (NIS2)",
      essentialDescription: "Essential entity under NIS2 directive",
      isImportantEntity: "Important Entity (NIS2)",
      importantDescription: "Important entity under NIS2 directive",
      suppliesToOEM: "Supplies to Automotive OEM",
      oemDescription: "Supplier to automotive manufacturers (TISAX relevant)",
      // Regulation Detection
      detectedRegulations: "Detected Regulations",
      detectingRegulations: "Analyzing your profile...",
      applicableRegulations: "Applicable Regulations",
      mandatory: "Mandatory",
      recommended: "Recommended",
      notApplicable: "Not Applicable",
      confirmRegulations: "Confirm applicable regulations",
      // Step 3: Frameworks
      step3Title: "Framework Selection",
      step3Subtitle: "Choose your baseline security frameworks",
      recommendedFrameworks: "Recommended Frameworks",
      selectFrameworks: "Select the frameworks you want to implement",
      priority: "Priority",
      reason: "Reason",
      controls: "Controls",
      ...
      step4Title: "Compliance Plan",
      step4Subtitle: "Review your generated compliance plan",
      generatingPlan: "Generating your compliance plan...",
      ...
      step5Subtitle: "Your organization is ready to go",
      completionMessage: "Congratulations! Your compliance profile has been set up successfully.",
      nextSteps: "Next Steps",
      goToDashboard: "Go to Dashboard",
      viewPlan: "View Compliance Plan",
      startAssessment: "Start First Assessment",
      // Errors
      errorLoadingIndustries: "Failed to load industries",
      errorLoadingCountries: "Failed to load countries",
      errorCreatingProfile: "Failed to create profile",
      errorDetectingRegulations: "Failed to detect regulations",
      errorGeneratingPlan: "Failed to generate plan",
      errorCompletingOnboarding: "Failed to complete onboarding",
    },
  },
  de: {
    // App
    ...
    nav: {
      ...
      nist: "NIST CSF",
      cobit: "COBIT",
      assurance: "Nachweisführung",
      assuranceHub: "Nachweisführung Hub",
      evidence: "Nachweise",
      testing: "Tests",
      audits: "Audits",
      bcm: "Business Continuity",
      incidentsShort: "Vorfälle",
    ...
    // Training & Security Awareness
    training: {
      title: "Sicherheitsbewusstseinsschulung",
      subtitle: "Lernen, uben und verbessern Sie Ihre Sicherheitsfahigkeiten",
      catalog: "Kurskatalog",
      myLearning: "Mein Lernen",
      leaderboard: "Bestenliste",
      // Stats
      coursesCompleted: "Kurse abgeschlossen",
      quizzesPassed: "Tests bestanden",
      ...
      modules: "Module",
      minutes: "Minuten",
      passingScore: "zum Bestehen",
      certificateIncluded: "Zertifikat enthalten",
      learningObjectives: "Lernziele",
      courseContent: "Kursinhalt",
      modulesTotal: "Module",
      minutesTotal: "Minuten insgesamt",
      // Difficulty levels
      "difficulty.beginner": "Anfanger",
      "difficulty.intermediate": "Fortgeschritten",
      "difficulty.advanced": "Experte",
      // Categories
      "categories.security_fundamentals": "Sicherheitsgrundlagen",
      "categories.phishing_awareness": "Phishing-Bewusstsein",
      "categories.data_protection": "Datenschutz",
      "categories.password_security": "Passwortsicherheit",
      "categories.social_engineering": "Social Engineering",
      "categories.compliance": "Compliance",
      "categories.incident_response": "Vorfallreaktion",
      "categories.secure_coding": "Sichere Programmierung",
      // Module types
      "moduleTypes.video": "Video",
      "moduleTypes.text": "Text",
      "moduleTypes.interactive": "Interaktiv",
      "moduleTypes.quiz": "Quiz",
      "moduleTypes.document": "Dokument",
      "moduleTypes.external_link": "Externer Link",
      // Enrollment
      enrollNow: "Jetzt einschreiben",
      enrollDescription: "Schreiben Sie sich ein, um mit dem Lernen zu beginnen und Ihren Fortschritt zu verfolgen.",
      startLearning: "Lernen beginnen",
      enrolling: "Einschreiben...",
      enrolledSuccessfully: "Erfolgreich im Kurs eingeschrieben!",
      enrollmentFailed: "Einschreibung fehlgeschlagen",
      // Progress
      yourProgress: "Ihr Fortschritt",
      modulesCompleted: "Module abgeschlossen",
      continueToNext: "Weiter zum nachsten Modul",
      courseCompleted: "Kurs abgeschlossen!",
      deadline: "Frist",
      overdueDeadline: "Frist uberschritten",
      // Module viewer
      backToCourse: "Zuruck zum Kurs",
      previousModule: "Zurück",
      nextModule: "Nachstes Modul",
      finishCourse: "Kurs abschliessen",
      progress: "Fortschritt",
      readyToComplete: "Bereit, dieses Modul abzuschliessen?",
      markAsComplete: "Markieren Sie dieses Modul als abgeschlossen, um Ihren Fortschritt zu verfolgen",
      markComplete: "Als abgeschlossen markieren",
      completing: "Wird abgeschlossen...",
      moduleCompleted: "Modul abgeschlossen!",
      completionFailed: "Modul konnte nicht als abgeschlossen markiert werden",
      noVideoAvailable: "Kein Video verfugbar",
      downloadDocument: "Laden Sie das Dokument herunter, um weiterzulernen",
      download: "Herunterladen",
      noContentAvailable: "Kein Inhalt verfugbar",
      externalResource: "Dieses Modul verlinkt auf eine externe Ressource",
      openResource: "Ressource offnen",
      quizModule: "Quiz-Modul",
      quizDescription: "Testen Sie Ihr Wissen mit diesem Quiz",
      startQuiz: "Quiz starten",
      quizNotAvailable: "Quiz nicht verfugbar",
      interactiveNotAvailable: "Interaktiver Inhalt nicht verfugbar",
      unknownModuleType: "Unbekannter Modultyp",
      completed: "Abgeschlossen",
      // Actions
      start: "Starten",
      view: "Ansehen",
      ...
      inProgress: "In Bearbeitung",
      assigned: "Zugewiesen",
      completedCourses: "Abgeschlossen",
      // Empty states
      noCourses: "Keine Kurse gefunden",
      noCoursesInProgress: "Keine Kurse in Bearbeitung",
      noAssignedCourses: "Keine zugewiesenen Kurse",
      noCompletedCourses: "Keine abgeschlossenen Kurse",
      // Course not found
      courseNotFound: "Kurs nicht gefunden",
      courseNotFoundMessage: "Der gesuchte Kurs existiert nicht.",
      moduleNotFound: "Modul nicht gefunden",
      moduleNotFoundMessage: "Das gesuchte Modul existiert nicht.",
    ...
    onboarding: {
      ...
      // Step 1: Organization Profile
      step1Title: "Organisationsprofil",
      step1Subtitle: "Erzählen Sie uns von Ihrer Organisation",
      organizationName: "Organisationsname",
      organizationNamePlaceholder: "Geben Sie den Namen Ihrer Organisation ein",
      industrySector: "Branche",
      selectIndustry: "Wählen Sie Ihre Branche",
      companySize: "Unternehmensgröße",
      selectSize: "Wählen Sie die Unternehmensgröße",
      country: "Hauptsitz",
      selectCountry: "Wählen Sie das Land",
      operatesInEU: "Tätig in der EU",
      euOperations: "EU-Geschäftstätigkeit",
      // Industry Categories
      ...
      general: "Allgemein",
      // Step 2: Special Status
      step2Title: "Regulatorischer Status",
      step2Subtitle: "Helfen Sie uns, anwendbare Vorschriften zu identifizieren",
      specialStatus: "Sonderstatus",
      isKritisOperator: "KRITIS-Betreiber",
      kritisDescription: "Betreiber kritischer Infrastrukturen in Deutschland",
      isBaFinRegulated: "BaFin-reguliert",
      bafinDescription: "Von der Bundesanstalt für Finanzdienstleistungsaufsicht beaufsichtigt",
      isEssentialService: "Wesentliche Einrichtung (NIS2)",
      essentialDescription: "Wesentliche Einrichtung gemäß NIS2-Richtlinie",
      isImportantEntity: "Wichtige Einrichtung (NIS2)",
      importantDescription: "Wichtige Einrichtung gemäß NIS2-Richtlinie",
      suppliesToOEM: "Zulieferer für Automobil-OEM",
      oemDescription: "Zulieferer für Automobilhersteller (TISAX-relevant)",
      // Regulation Detection
      detectedRegulations: "Erkannte Vorschriften",
      detectingRegulations: "Analysiere Ihr Profil...",
      applicableRegulations: "Anwendbare Vorschriften",
      mandatory: "Verpflichtend",
      recommended: "Empfohlen",
      notApplicable: "Nicht anwendbar",
      confirmRegulations: "Bestätigen Sie die anwendbaren Vorschriften",
      // Step 3: Frameworks
      step3Title: "Framework-Auswahl",
      step3Subtitle: "Wählen Sie Ihre Basis-Sicherheitsrahmenwerke",
      recommendedFrameworks: "Empfohlene Rahmenwerke",
      selectFrameworks: "Wählen Sie die Rahmenwerke, die Sie implementieren möchten",
      priority: "Priorität",
      reason: "Begründung",
      controls: "Kontrollen",
      ...
      // Step 4: Compliance Plan
      step4Title: "Compliance-Plan",
      step4Subtitle: "Überprüfen Sie Ihren generierten Compliance-Plan",
      generatingPlan: "Generiere Ihren Compliance-Plan...",
      planOverview: "Planübersicht",
      totalItems: "Gesamtpunkte",
      categories: "Kategorien",
      regulations: "Vorschriften",
      frameworks: "Rahmenwerke",
      timeline: "Zeitplan",
      planItems: "Planpunkte",
      category: "Kategorie",
      owner: "Verantwortlicher",
      dueDate: "Fälligkeitsdatum",
      evidence: "Nachweis erforderlich",
      // Priority Levels
      priorityCritical: "Kritisch",
      priorityHigh: "Hoch",
      priorityMedium: "Mittel",
      priorityLow: "Niedrig",
      // Step 5: Completion
      step5Title: "Einrichtung abgeschlossen",
      step5Subtitle: "Ihre Organisation ist startklar",
      completionMessage: "Herzlichen Glückwunsch! Ihr Compliance-Profil wurde erfolgreich eingerichtet.",
      nextSteps: "Nächste Schritte",
      goToDashboard: "Zum Dashboard",
      viewPlan: "Compliance-Plan anzeigen",
      startAssessment: "Erste Bewertung starten",
      // Errors
      errorLoadingIndustries: "Fehler beim Laden der Branchen",
      errorLoadingCountries: "Fehler beim Laden der Länder",
      errorCreatingProfile: "Fehler beim Erstellen des Profils",
      errorDetectingRegulations: "Fehler beim Erkennen der Vorschriften",
      errorGeneratingPlan: "Fehler beim Generieren des Plans",
      errorCompletingOnboarding: "Fehler beim Abschließen der Einrichtung",
    },
  },
};
