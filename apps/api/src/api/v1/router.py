...
# Enterprise Features
api_router.include_router(bsi_grundschutz.router, tags=["BSI IT-Grundschutz"])
...
api_router.include_router(gdpr.router, tags=["GDPR Compliance"])
api_router.include_router(nist.router, tags=["NIST CSF 2.0 Compliance"])
api_router.include_router(cobit.router, tags=["COBIT 2019 Compliance"])
api_router.include_router(copilot.router, tags=["AI Copilot"])
api_router.include_router(onboarding.router, tags=["Onboarding"])

# ISMS ↔ SOC Bridge
api_router.include_router(evidence_bridge.router, tags=["Evidence Bridge"])
