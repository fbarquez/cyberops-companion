...
- **Generated By:** IR Companion v{self.config.version}
...
*This report was generated by IR Companion, an incident response decision support tool.*"""
    ...
    def create_evidence_package(
        ...
        with zipfile.ZipFile(zip_path, "w", zipfile.ZIP_DEFLATED) as zf:
            ...
            metadata = {
                ...
                "analyst": incident.analyst_name,
                "ir_companion_version": self.config.version,
            }
            zf.writestr(
